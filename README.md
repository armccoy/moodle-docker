...
| `MOODLE_DOCKER_DB_VERSION`                | no        | Docker tag - see relevant database page on docker-hub | mysql: 8.0 <br/>pgsql: 17 <br/>mariadb: 11.4 <br/>mssql: 2017-latest <br/>oracle: 21| The database server docker image tag |
